...
import './Tank.css'
import TankData from './TankData.jsx'
  ...
  return (
    <div>
      <section className="TankSection">
        <div className="TankHead">
          <h3>Best selling For Tank & Decoration:</h3>
        </div>
        <div className="TankScrollContainer">
          <button className="scroll-btn left" onClick={() => scroll(-300)}>
            ❮
          </button>
          <div className="Tankcollection" ref={scrollRef}>
            {infiniteTankdata.map((item, index) => (
              <div className="TankcollectCard" key={index}>
                <div className="TankImgContain">
